...
public class SourceDestinationPublisher : MonoBehaviour
{
    ...
    public void Publish()
    {
        ...
        {
            position = m_Targets[0].transform.position.To<FLU>(),
            orientation = Quaternion.Euler(90, m_Targets[0].transform.eulerAngles.y, 0).To<FLU>()
        };
        ...
        {
            position = m_TargetPlacements[0].transform.position.To<FLU>(),
